...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '物理乐园', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '物理老师🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-three-delta-71.vercel.app/', // 网站地址
